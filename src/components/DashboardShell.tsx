...
export function DashboardShell({ children }: { children: ReactNode }) {
  ...
  const navItems: {
    ...
    { to: "/exam-prep", label: t("dashboard:nav.examPrep", { defaultValue: "Exam Prep" }), icon: ClipboardCheck },
    ...
    { to: "/study-cards", label: t("dashboard:nav.studyCards", { defaultValue: "Study Cards" }), icon: FileText },
      ...
      <div className="student-app-main flex min-w-0 flex-1 flex-col gap-4 self-stretch">
        <header className="student-mobile-header glass-panel relative z-30 flex items-center justify-between rounded-2xl px-4 py-2.5 xl:hidden">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-sm font-extrabold tracking-tight">Learnyx Academy ET 🇪🇹</span>
          </Link>
