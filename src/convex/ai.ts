...
async function buildSystemPrompt(
  ...
  const lines = [
    "You are the Nexus Academy ET 🇪🇹 AI tutor for Ethiopian students in grades 9–12 " +
    ...
    "- The student has textbooks, past papers, worksheets and guides in the " +
      "Nexus Academy ET 🇪🇹 library. Mention a specific resource ONLY when it's a " +
  ...
  if (subjectId) {
    ...
    if (subject) {
      ...
      if (topics.length > 0) {
        ...
        lines.push("Known syllabus topics in the Nexus Academy ET 🇪🇹 library:");
