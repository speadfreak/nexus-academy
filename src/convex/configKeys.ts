...
export const INTEGRATION_KEYS = [
  ...
  { key: "OPENROUTER_MODEL", label: "OpenRouter Model (optional)", category: "ai", description: "Optional model override. Defaults to meta-llama/llama-3.3-70b-instruct:free. Other free models: deepseek/deepseek-r1:free, qwen/qwen-2.5-coder-32b-instruct:free, google/gemma-2-9b-it:free" },
  { key: "CEREBRAS_API_KEY", label: "Cerebras (Mock Exams fallback 2)", category: "ai", description: "Second fallback for mock exam generation when Gemini + OpenRouter both fail. Free tier: 30 RPM, 1M tokens/day. Get a free key at cerebras.ai.", helpUrl: "https://cerebras.ai", helpLabel: "cerebras.ai" },
  { key: "CEREBRAS_MODEL", label: "Cerebras Model (optional)", category: "ai", description: "Optional model override. Defaults to llama3.1-8b. Also available: llama3.1-70b." },
